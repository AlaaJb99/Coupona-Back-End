...
public class CouponController {
	...
	@PreAuthorize("hasAuthority('CUSTOMER')")
	@PostMapping("/customer/ispurchase")
	public void isPurchased(@RequestBody PurchaseCoupon coupon){
		couponService.isPurchased(coupon.getCustomerId(), coupon.getCouponId());
	}
